...
function sortTable(column) {
    ...
    // Get column index for sorting (adjusted for pengabdian Pusat table structure)
    const columnMap = {
        'Judul': 1,
        'SKEMA': 2,
        'Nama': 3,
    ...
    rows.sort((a, b) => {
        ...
        } else if (column === 'Tahun' || column === 'JumlahAnggota' || column === 'JumlahMshTerlibat') {
